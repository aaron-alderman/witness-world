...
test("engentus frontend serves the login shell and loads no pipeline witnesses", async () => {
  ...
  try {
    ...
    assert.doesNotMatch(goodmanHtml, /engentus-browser-runtime\.js/);
    ...
    assert.doesNotMatch(millChargePageHtml, /engentus-browser-runtime\.js/);
    ...
    assert.doesNotMatch(millForcePageHtml, /engentus-browser-runtime\.js/);
