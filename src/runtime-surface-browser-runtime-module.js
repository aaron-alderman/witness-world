...
import {
  ...
  currentWitnessCount,
  eventPayloadFromDomEvent,
  eventValuesFromDomEvent,
...
const PROCESS_WITNESS_KINDS = new Set([
  ...
  "desire.definePolicy"
    ...
    eventValuesFromDomEvent.toString(),
    eventPayloadFromDomEvent.toString(),
    runtimeValueFromSpec.toString(),
