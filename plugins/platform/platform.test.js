...
test("platform console layout compiles authored top-level surface metadata from RVM", () => {
  ...
  assert.equal(bridgesListSurface.props.supplementalTableSource, "bridges");
  ...
  assert.equal(bridgesDetailSurface.props.supplementalDetailSource, "bridges");
  ...
  assert.equal(governanceListSurface.props.supplementalTableSource, "governance");
  ...
  assert.equal(governanceDetailSurface.props.supplementalDetailSource, "governance");
  ...
  assert.equal(semanticsListSurface.props.supplementalTableSource, "semantics");
  ...
  assert.equal(semanticsDetailSurface.props.supplementalDetailSource, "semantics");
  ...
  assert.equal(packageCoexistenceListSurface.props.supplementalTableSource, "packageCoexistence");
  ...
  assert.equal(packageCoexistenceDetailSurface.props.supplementalDetailSource, "packageCoexistence");
  ...
  assert.equal(packageConvergenceListSurface.props.supplementalTableSource, "packageConvergence");
  ...
  assert.equal(packageConvergenceDetailSurface.props.supplementalDetailSource, "packageConvergence");
