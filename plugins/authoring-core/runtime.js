...
const authoringRoutes = Object.freeze([
  ...
  exactRoute("POST", "/api/compute-modules", "computeModule.create"),
  exactRoute("POST", "/api/compute-module-sources", "computeModule.source.upsert"),
  exactRoute("DELETE", "/api/compute-module-sources", "computeModule.source.markDeleted"),
  exactRoute("POST", "/api/compute-module-smoke-tests", "computeModuleSmokeTest.upsert"),
  exactRoute("DELETE", "/api/compute-module-smoke-tests", "computeModuleSmokeTest.markDeleted"),
  exactRoute("POST", "/api/compute-module-smoke-tests/run", "computeModuleSmokeTest.run"),
  ...
  exactRoute("POST", "/api/package-patches/source", "packagePatch.source.upsert"),
