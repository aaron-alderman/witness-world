...
export function loadBootstrapProposalSubmitContracts({
  manifestFile = "bootstrap-proposal-submit-contracts.wtoml",
  contractKind = "bootstrapProposalSubmit",
  baseDir = __dirname,
...
export const bootstrapProposalSubmitContractsByFamily = loadBootstrapProposalSubmitContracts();
