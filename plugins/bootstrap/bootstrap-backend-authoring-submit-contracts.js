...
export function loadBootstrapBackendAuthoringSubmitContracts({
  manifestFile = "bootstrap-backend-authoring-submit-contracts.wtoml",
  contractKind = "bootstrapBackendAuthoringSubmit",
  baseDir = __dirname,
...
export const bootstrapBackendAuthoringSubmitContractsByFamily = loadBootstrapBackendAuthoringSubmitContracts();
