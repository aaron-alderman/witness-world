...
export function loadBootstrapBackendVersionSubmitContracts({
  manifestFile = "bootstrap-backend-version-submit-contracts.wtoml",
  contractKind = "bootstrapBackendVersionSubmit",
  baseDir = __dirname,
...
export const bootstrapBackendVersionSubmitContractsByFamily = loadBootstrapBackendVersionSubmitContracts();
