...
export function loadBootstrapProposalAdjacentSubmitContracts({
  manifestFile = "bootstrap-proposal-adjacent-submit-contracts.wtoml",
  contractKind = "bootstrapProposalAdjacentSubmit",
  baseDir = __dirname,
...
export const bootstrapProposalAdjacentSubmitContractsByFamily = loadBootstrapProposalAdjacentSubmitContracts();
