...
export function loadBootstrapCapabilitySubmitContracts({
  manifestFile = "bootstrap-capability-submit-contracts.wtoml",
  contractKind = "bootstrapCapabilitySubmit",
  baseDir = __dirname,
...
export const bootstrapCapabilitySubmitContractsByFamily = loadBootstrapCapabilitySubmitContracts();
