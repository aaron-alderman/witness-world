...
test("starter plan builds ordered bootstrap requests and maps host owners", () => {
  const plan = buildBootstrapStarterPlan({
    ...
    blueprint: {
      ...
      types: [{ id: "nativeTodoDraftTitle" }],
      collections: [{ id: "native_todo_items" }],
      messages: [{ id: "nativeTodoRefreshRequested" }],
      projections: [{ id: "nativeTodoStatusProjection" }],
      processes: [{ id: "nativeTodoProcess" }],
      boundaries: [{ id: "nativeTodoLoadBoundary" }],
      policies: [{ id: "nativeTodoLoadPolicy" }],
      surfaces: [{ id: "native_todo_title" }],
      routes: [{ id: "home", handler: "page.surface" }],
  ...
  assert.deepEqual(plan.requests, [
    ...
    { url: "/api/types", body: { id: "nativeTodoDraftTitle" } },
    { url: "/api/collections", body: { id: "native_todo_items" } },
    { url: "/api/messages", body: { id: "nativeTodoRefreshRequested" } },
    { url: "/api/projections", body: { id: "nativeTodoStatusProjection" } },
    { url: "/api/processes", body: { id: "nativeTodoProcess" } },
    { url: "/api/boundaries", body: { id: "nativeTodoLoadBoundary" } },
    { url: "/api/policies", body: { id: "nativeTodoLoadPolicy" } },
    { url: "/api/surfaces", body: { id: "native_todo_title" } },
    { url: "/api/routes", body: { id: "home", handler: "page.surface" } },
