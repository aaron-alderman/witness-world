...
export function loadBootstrapRuntimeIntegrationDirectSubmitContracts({
  manifestFile = "bootstrap-runtime-integration-direct-submit-contracts.wtoml",
  contractKind = "bootstrapRuntimeIntegrationDirectSubmit",
  fieldKind = "bootstrapRuntimeIntegrationDirectSubmitField",
  baseDir = __dirname,
...
export const bootstrapRuntimeIntegrationDirectSubmitContractsByFamily = loadBootstrapRuntimeIntegrationDirectSubmitContracts();
