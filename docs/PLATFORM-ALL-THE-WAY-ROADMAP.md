...
- [L] Row extraction, sort/pagination policy, detail-subtable columns, and most card internals across the console remain JS-backed by surface name, so this is still not full generic rendered-RVM replacement.
