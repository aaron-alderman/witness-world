...
- [L] Card field selection and many fallback list/text card compositions across the console still remain JS-backed by surface name, so this is still not full generic rendered-RVM replacement.
