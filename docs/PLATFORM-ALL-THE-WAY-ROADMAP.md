...
- [L] Nested history/relationship table row extraction, richer stream-link phrasing, and most card internals across the console remain JS-backed by surface name, so this is still not full generic rendered-RVM replacement.
