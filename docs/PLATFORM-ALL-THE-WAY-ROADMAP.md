...
- [L] Richer stream-link phrasing and most card internals across the console still remain JS-backed by surface name, so this is still not full generic rendered-RVM replacement.
