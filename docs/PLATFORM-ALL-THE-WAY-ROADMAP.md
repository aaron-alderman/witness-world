...
- [L] Card field selection and some fallback list/text card compositions for future or partially authored surfaces still remain JS-backed by surface name, so this is still not full generic rendered-RVM replacement.
