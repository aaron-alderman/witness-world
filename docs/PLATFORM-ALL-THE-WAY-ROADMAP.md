...
- [L] Most table/card content and pagination behavior across the console remain JS-backed by surface name, so this is still not full generic rendered-RVM replacement.
